...
typedef struct
{
	...
	lv_chart_series_t *Main_Main_chart_1_0;
	lv_obj_t *Main_Main_btnMainSwScr;
	lv_obj_t *Main_Main_btnMainSwScr_label;
	lv_obj_t *Main_btn_Data_collect;
	lv_obj_t *Main_btn_Data_collect_label;
	lv_obj_t *Main_label_1;
	lv_obj_t *Model_Training;
	bool Model_Training_del;
	lv_obj_t *Model_Training_img_1;
	lv_obj_t *Model_Training_Main_btnMainSwScr;
	lv_obj_t *Model_Training_Main_btnMainSwScr_label;
	...
	lv_obj_t *DS_Collection_label_1;
	lv_obj_t *DS_Collection_btn_1;
	lv_obj_t *DS_Collection_btn_1_label;
	lv_obj_t *DS_Collection_label_2;
}lv_ui;
